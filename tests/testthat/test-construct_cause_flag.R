...
test_that("construct_cause_flag correctly flags rows based on exact match", {
  data <- data.frame(
    ID = 1:5,
  ...
  result <- construct_cause_flag(data, "E85|E619", "FIC10MEN", "CHECK")
...
test_that("construct_cause_flag correctly flags rows based on partial match", {
  data <- data.frame(
    ID = 1:5,
  ...
  result <- construct_cause_flag(data, "E85", "FIC10MEN", "CHECK")
...
test_that("construct_cause_flag creates new column with 0s if no match found", {
  data <- data.frame(
    ID = 1:5,
...
test_that("construct_cause_flag handles multiple code patterns", {
  data <- data.frame(
    ID = 1:5,
...
test_that("construct_cause_flag works with no matching columns", {
  data <- data.frame(
    ID = 1:5,
...
test_that("construct_cause_flag works with empty dataset", {
  data <- data.frame(
    ID = integer(0),
