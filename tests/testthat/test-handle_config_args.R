...
test_that("handle_config_args converts arguments correctly", {
  ...
  # Call the function
  result <- handle_config_args(args)
...
test_that("handle_config_args handles null arguments correctly", {
...
test_that("handle_config_args handles non-character data arguments correctly", {
...
test_that("handle_config_args handles non-character date_var and output_path arguments correctly", {
